    ...
    <>
      <div className="bg-white_A700 flex font-roboto items-start justify-end mx-[auto] sm:pr-[20px] md:pr-[40px] pr-[72px] py-[72px] w-[100%]">
        <div className="flex flex-col gap-[32px] justify-start mt-[20px] md:w-[100%] w-[94%]">
          <div className="flex md:flex-col flex-row md:gap-[20px] items-end justify-start mr-[19px] md:w-[100%] w-[99%]">
            <div className="flex flex-col justify-start md:w-[100%] w-[57%]">
              <Text
              ...
              <div className="flex md:flex-col flex-row gap-[16px] items-center justify-end ml-[auto] mt-[57px] md:w-[100%] w-[94%]">
                <Img
                ...
                />
                <List
                  className="sm:flex-col flex-row gap-[24px] grid sm:grid-cols-1 md:grid-cols-3 grid-cols-6 md:w-[100%] w-[97%]"
              ...
              <div className="flex flex-col items-start justify-start mt-[40px] w-[100%]">
                <Line className="bg-bluegray_600 h-[1px] w-[100%]" />
                <div className="flex flex-row gap-[9px] items-center justify-start md:ml-[0] ml-[72px] mt-[23px] md:w-[100%] w-[23%]">
                  <Img
                ...
                <Line className="bg-bluegray_600 h-[1px] mt-[22px] w-[100%]" />
              </div>
            </div>
            <Img
              src="images/img_arrowright.svg"
              className="h-[15px] mb-[154px] md:ml-[0] ml-[17px] md:mt-[0] mt-[136px] w-[auto]"
              alt="arrowright"
            />
            <div className="bg-gray_400 h-[214px] md:ml-[0] ml-[112px] md:mt-[0] mt-[91px] rounded-[16px] w-[33%]"></div>
          </div>
          <div className="flex flex-col items-start justify-start md:ml-[0] ml-[66px] md:w-[100%] w-[95%]">
            ...
            <div className="flex md:flex-col flex-row md:gap-[40px] items-start justify-between mt-[3px] w-[100%]">
              <div className="flex md:flex-1 flex-col items-start justify-start md:mt-[0] mt-[14px] md:w-[100%] w-[55%]">
                ...
                <div className="flex flex-row sm:gap-[40px] items-start justify-between mt-[26px] w-[100%]">
                  <Text
                    className="font-bold mt-[6px] text-gray_503 text-left w-[auto]"
                    variant="body10"
                  >
                    2D
                  </Text>
              ...
              <div className="flex md:flex-1 flex-col items-start justify-start md:w-[100%] w-[36%]">
                ...
                <div className="h-[323px] md:h-[385px] mt-[62px] relative w-[100%]">
                  <div className="flex flex-col h-[100%] items-start justify-start m-[auto] w-[90%]">
                    ...
                    <Text
                      className="font-normal mt-[117px] not-italic text-bluegray_600 text-left w-[auto]"
                      variant="body18"
                    >
...
export default PilihJadwalOnePage;
