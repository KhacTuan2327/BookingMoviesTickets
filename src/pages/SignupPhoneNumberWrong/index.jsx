...
const SignupPhoneNumberWrongPage = () => {
          ...
          <div className="h-[1203px] md:h-[900px] pb-[303px] md:px-[20px] relative w-[100%]">
            ...
            <div className="absolute flex md:flex-col flex-row md:gap-[40px] inset-x-[0] items-start justify-between mx-[auto] top-[5%] w-[92%]">
              ...
              <div className="bg-white_A700 flex flex-col items-start justify-end p-[38px] sm:px-[20px] md:w-[100%] w-[50%]">
                ...
                <Text
                  className="font-normal md:ml-[0] ml-[41px] mt-[63px] not-italic text-left text-red_600 w-[auto]"
                  variant="body12"
                >
                  FULL NAME
                </Text>
                ...
                <Text
                  className="font-normal md:ml-[0] ml-[38px] mt-[28px] not-italic text-left text-red_600 w-[auto]"
                  variant="body12"
                >
                  PASSWORD
                </Text>
                <div className="flex flex-col gap-[8px] items-start justify-start md:ml-[0] ml-[41px] mt-[11px] sm:w-[100%] w-[423px]">
                  <div className="md:h-[32px] h-[37px] relative w-[100%]">
                    ...
                    <Img
                      src="images/img_arrowup_red_600.svg"
                ...
                <Text
                  className="font-normal md:ml-[0] ml-[38px] mt-[30px] not-italic text-left text-red_600 w-[auto]"
                  variant="body12"
                >
                  EMAIL ADDRESS
                </Text>
                ...
                <Text
                  className="font-normal md:ml-[0] ml-[41px] mt-[18px] not-italic text-left text-red_300 w-[auto]"
                  variant="body18"
                >
                  Please enter valid keywords
                </Text>
                <Button
                  className="cursor-pointer font-medium leading-[normal] md:ml-[0] ml-[38px] mt-[30px] text-[20px] text-bluegray_300 text-center w-[423px]"
...
export default SignupPhoneNumberWrongPage;
