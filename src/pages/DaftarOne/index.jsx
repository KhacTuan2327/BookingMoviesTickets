      ...
      <div className="bg-gray_201 flex sm:flex-col md:flex-col flex-row font-roboto gap-[213px] sm:gap-[40px] md:gap-[40px] items-center mx-[auto] p-[64px] sm:px-[20px] md:px-[40px] w-[100%]">
        ...
        <div className="bg-white_A700 flex items-start justify-end mr-[56px] p-[40px] md:px-[20px] md:w-[100%] w-[52%]">
          <div className="flex flex-col items-start justify-start md:ml-[0] ml-[39px] mt-[56px] md:w-[100%] w-[68%]">
            ...
            <Text
              className="font-normal mt-[44px] not-italic text-gray_601 text-left w-[auto]"
              variant="body12"
            >
              NOMOR HANDPHONE
            </Text>
            <div className="flex flex-row items-start justify-start mt-[16px] md:w-[100%] w-[85%]">
              <Text
              ...
              <Line className="bg-gray_400 h-[17px] ml-[20px] my-[4px] w-[1px]" />
              <Text
                className="font-normal ml-[20px] mt-[3px] not-italic text-bluegray_100 text-left w-[auto]"
                variant="body11"
              >
                Masukkan nomor handphone
              </Text>
            </div>
            <Line className="bg-gray_506 h-[1px] mt-[9px] rotate-[-90deg] w-[99%]" />
            <Button
              className="cursor-pointer font-medium mt-[44px] text-[16px] text-center text-deep_orange_50 w-[399px]"
            ...
            <div className="flex flex-row gap-[29px] items-start justify-start mt-[203px] md:w-[100%] w-[49%]">
              <Text
