            ...
            <div className="flex md:flex-1 flex-col gap-[42px] items-center justify-start md:mt-[0] mt-[26px] md:w-[100%] w-[55%]">
              <div className="flex flex-col gap-[24px] items-center justify-start w-[100%]">
                <div className="flex flex-col gap-[22px] items-center justify-start w-[100%]">
                  <div className="h-[82px] px-[6px] relative md:w-[100%] w-[98%]">
                    ...
                    <div className="absolute flex h-[100%] inset-[0] items-center justify-center m-[auto] w-[86%]">
                      ...
                      >
                        <div className="bg-bluegray_901 hover:border-[1px] border-[1px] hover:border-bluegray_600 border-bluegray_600 hover:border-solid border-solid hover:cursor-pointer flex flex-col gap-[4px] items-center justify-center hover:mx-[0] p-[18px] rounded-[8px] hover:shadow-bs2 shadow-bs2 hover:w-[100%] w-[auto]">
                          <Text
                        ...
                        <div className="bg-bluegray_901 hover:border-[1px] hover:border-bluegray_600 hover:border-solid hover:cursor-pointer flex flex-col gap-[4px] items-center justify-center hover:mx-[0] p-[18px] rounded-[8px] hover:shadow-bs2 hover:w-[100%] w-[auto]">
                          <Text
                        ...
                        <div className="bg-white_A700 hover:border-[1px] border-[1px] hover:border-bluegray_600 border-bluegray_600 hover:border-solid border-solid hover:cursor-pointer flex flex-col gap-[4px] items-center justify-center hover:mx-[0] p-[18px] rounded-[8px] hover:shadow-bs2 hover:w-[100%] w-[auto]">
                          <Text
                            className="font-medium text-bluegray_600 text-left w-[auto]"
                            variant="body13"
                          >
                ...
                <div className="flex flex-col gap-[32px] items-start justify-start w-[100%]">
                  ...
                  <div className="flex md:flex-col flex-row md:gap-[42px] items-center justify-between w-[100%]">
                    <Input
                      value={inputvalue}
                    ...
                    ></Input>
                    <div className="flex md:flex-1 flex-row items-center justify-end pr-[3px] md:w-[100%] w-[41%]">
            ...
            <div className="flex md:flex-1 flex-col gap-[30px] items-center justify-start md:w-[100%] w-[36%]">
              <div className="flex items-center justify-start md:w-[100%] w-[99%]">
                <div className="flex flex-col items-start justify-start w-[100%]">
                  ...
                  <div className="flex flex-row gap-[43px] items-start justify-start mt-[21px] md:w-[100%] w-[63%]">
...
export default ChoosingScheduleOnePage;
