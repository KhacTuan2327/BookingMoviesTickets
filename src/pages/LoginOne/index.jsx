              ...
              <div className="bg-white_A700 flex flex-col items-start justify-end p-[38px] sm:px-[20px] md:w-[100%] w-[57%]">
                ...
                <div className="flex flex-col gap-[8px] items-start justify-start md:ml-[0] ml-[41px] mt-[13px] sm:w-[100%] w-[423px]">
                  <div className="flex sm:flex-col flex-row gap-[16px] items-center justify-start w-[100%]">
                    <Input
                      className="flex-1 font-normal leading-[normal] not-italic text-[20px] placeholder:text-bluegray_300 text-bluegray_300 text-left w-[100%]"
                ...
                <div
                  className="common-pointer flex items-center justify-start md:ml-[0] ml-[41px] mt-[14px] w-[auto]"
