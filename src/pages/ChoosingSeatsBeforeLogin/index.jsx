...
import { Text, Img, Line, Button, SelectBox, CheckBox, List } from "components";
import { useNavigate } from "react-router-dom";

const ChoosingSeatsBeforeLoginPage = () => {
    ...
    <>
      <div className="bg-white_A700 flex font-roboto items-center justify-start mx-[auto] w-[100%]">
        <div className="flex flex-col justify-start w-[100%]">
          ...
          <div className="flex sm:flex-col flex-row md:gap-[40px] items-center justify-between max-w-[1086px] mt-[69px] mx-[auto] md:px-[20px] w-[100%]">
            <SelectBox
              className="sm:flex-1 font-medium sm:text-[20px] md:text-[22px] text-[24px] text-bluegray_900 text-left sm:w-[100%] w-[auto]"
          ...
          <div className="flex items-center justify-start max-w-[1096px] mt-[30px] mx-[auto] md:px-[20px] w-[100%]">
            <List
          ...
          <div className="flex md:flex-col flex-row md:gap-[20px] items-center justify-start max-w-[1131px] mt-[61px] mx-[auto] md:px-[20px] w-[100%]">
            <div className="flex md:flex-1 flex-col gap-[7px] items-start justify-start md:w-[100%] w-[56%]">
              <div className="flex flex-row items-start justify-between md:w-[100%] w-[73%]">
                <Text
            ...
            <div className="flex items-center justify-center mb-[79px] w-[100%]">
              <div className="flex flex-col gap-[12px] items-center justify-center w-[100%]">
                ...
                <div className="flex md:flex-col flex-row md:gap-[20px] items-start justify-start md:ml-[0] ml-[30px] mr-[166px] md:w-[100%] w-[87%]">
                  ...
                  <div className="flex flex-col gap-[37px] items-start justify-start md:ml-[0] ml-[154px] md:mt-[0] mt-[26px] md:w-[100%] w-[22%]">
...
export default ChoosingSeatsBeforeLoginPage;
